		...
		<nav class='cv-menu'>
			<a href="#" class="menu-icon">
	      	...
	      	<div class='trigger'>
				...
				<a target="_blank" href='http://niamhlawlor.com/cv-june.pdf'>PDF</a>
			</div>
		</nav>
	</div>
		...
		<div id='about'>
			<ul class="cv-section">
				...
				<li class='about-blurb'>
					...
					<p>
					Aside from my technical interests , I like to read and write, have a keen interest in sport and love travelling and exploring new languages and cultures. </p>
				</li>
			</ul>
		</div>
		<div id='projects'>
			...
			<ul class="cv-section">
				...
				<li>
					<div class="col-md-offset-6 col-md-6 position-element lefted">
						...
						<div class='period'>February 2016 - May 2016</div>
					</div>
				</li>
				<li>
					<div class="col-xs-12 position-element">
