...
This is still an ongoing project. I am currently in the process of adding more events, locations and reviews. Possibile future features include adding user generated feedback and rating to accompany the curated content.
...
<table class='overview-grid'>
	...
	<tr>
		<td>Technologies</td>
		<td>Javascript, CSS, NodeJS, MongoDB </td>
	</tr>
	<tr>
		<td>Libraries/Frameworks</td>
		<td>ReactJS, Mongoose </td>
	</tr>
	<tr>
		<td>Open Source</td>
		<td>No</td>
	...
	<tr>
		<td>Live Demo</td>
		<td><a href="https://thisislondon.org" target="_blank">Here</a></td>
	</tr>
</table>
